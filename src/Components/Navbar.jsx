...
import { Button, Box, Flex, IconButton, useDisclosure, VStack, Drawer, DrawerBody, DrawerFooter, DrawerHeader, DrawerOverlay, DrawerContent, DrawerCloseButton, HStack, Link as ChakraLink } from '@chakra-ui/react';
            ...
            >
              {Links.map((el) =>
                (<ScrollLink
                  ...
                  offset={-50}
                >
                  <ChakraLink fontSize="20px" color="#D5FFD0" onClick={onClose}>
                    {el.title}
                  </ChakraLink>
                </ScrollLink>)
              )}
